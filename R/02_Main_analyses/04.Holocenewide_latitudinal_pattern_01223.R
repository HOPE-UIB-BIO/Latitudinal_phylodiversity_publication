...
# Extract summary of GAM models 
overall_gam <- 
  read_rds("Outputs/Data/v2_121023/Overall_gam_lat_PD_271023.rds") 

gam_summary_mpd <-
  flextable::as_flextable(overall_gam[1, ]$gam_model[[1]])
save_as_docx(
  gam_summary_mpd,
...
gam_summary_mntd <-
  flextable::as_flextable(overall_gam[2, ]$gam_model[[1]])
save_as_docx(
  gam_summary_mntd,
